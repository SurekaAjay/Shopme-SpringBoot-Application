...
public class OrderDetail  extends IdBasedEntity{
	...
	@ManyToOne //multiple order details can have 1 product id. Like multiiple customers buying same iphone whihc has product id 1
	@JoinColumn(name = "product_id")
	private Product product;
	
	@ManyToOne    //multiple order_details can have 1 order id
